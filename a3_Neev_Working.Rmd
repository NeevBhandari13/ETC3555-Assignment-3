...
# Add the missing columns to test_x, initializing them to 0
for (col in missing_cols) {
  test_x <- cbind(test_x, matrix(0, nrow = nrow(test_x), ncol = 1))
...
any(is.na(train_x))  # Should return FALSE
any(is.na(train_y))  # Should return FALSE
```
